from scanner import token_scanner, scanner
from tokens_with_regex import tokens, Space, StringQuotedLiteral, StringLiteral,  Indent, SequenceItemIndent, MappingKey
...
with open("schedule.yaml") as f:
    ...
    print(root, file=open("xml_from_yaml_regex.xml", "w", encoding="utf-8"))
